...
resource "aws_lambda_function" "secure_data_vault_lambda_function" {
...
resource "aws_lambda_permission" "allow_bucket" {
  ...
  function_name = aws_lambda_function.secure_data_vault_lambda_function.function_name    # DON'T use function_arn in the place of function_name 
